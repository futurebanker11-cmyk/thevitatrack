...
export const metadata: Metadata = {
  title: 'Health Tools | VitaTrack',
  description: 'Free health calculators and tools for seniors.',
  ...
  return (
    <>
      ...
      <main style={{ maxWidth: '960px', margin: '0 auto', padding: '40px 20px 60px' }}>
        ...
        <p style={{ color: '#555550', marginBottom: '32px', fontSize: '1.05rem' }}>Free health calculators and tools for seniors.</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '16px', margin: '32px 0' }}>
          {articles.map(a => (
            <Link key={a.slug} href={'/tools/' + a.slug} className="article-card">
              <h2>{a.title}</h2>
