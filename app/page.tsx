    ...
    <>
      ...
      <div className="main">
        ...
        <div className="guides-grid">
          <a href="https://payhip.com/b/i8u4X" target="_blank" rel="noopener" className="gc"><div className="gc-cover"><div className="bw"><div className="bk"><div className="bk-f"><img src="/assets/covers/heart-bp-protocol.webp" alt="Heart After 60" style={{width:'100%',height:'100%',objectFit:'cover'}} loading="lazy" /></div><div className="bk-sp" style={{background:'#7f1d1d'}}></div><div className="bk-pg"></div><div className="bk-sh"></div></div></div></div><div className="gc-body"><div className="gc-title">The Heart After 60 Playbook</div><span className="gc-price">$12</span></div></a>
          <a href="https://payhip.com/b/RHlTO" target="_blank" rel="noopener" className="gc"><div className="gc-cover"><div className="bw"><div className="bk"><div className="bk-f"><img src="/assets/covers/prostate-protocol.webp" alt="Prostate Fix" style={{width:'100%',height:'100%',objectFit:'cover'}} loading="lazy" /></div><div className="bk-sp" style={{background:'#1e3a5f'}}></div><div className="bk-pg"></div><div className="bk-sh"></div></div></div></div><div className="gc-body"><div className="gc-title">The Prostate Fix Playbook</div><span className="gc-price">$12</span></div></a>
          <a href="https://payhip.com/b/1h6uW" target="_blank" rel="noopener" className="gc"><div className="gc-cover"><div className="bw"><div className="bk"><div className="bk-f"><img src="/assets/covers/glp1-survival-guide.webp" alt="Ozempic Guide" style={{width:'100%',height:'100%',objectFit:'cover'}} loading="lazy" /></div><div className="bk-sp" style={{background:'#78350f'}}></div><div className="bk-pg"></div><div className="bk-sh"></div></div></div></div><div className="gc-body"><div className="gc-title">The Ozempic Companion</div><span className="gc-price">$14</span></div></a>
          <a href="https://payhip.com/b/ckaY7" target="_blank" rel="noopener" className="gc"><div className="gc-cover"><div className="bw"><div className="bk"><div className="bk-f"><img src="/assets/covers/supplement-blueprint.webp" alt="Supplement Stack" style={{width:'100%',height:'100%',objectFit:'cover'}} loading="lazy" /></div><div className="bk-sp" style={{background:'#0f3320'}}></div><div className="bk-pg"></div><div className="bk-sh"></div></div></div></div><div className="gc-body"><div className="gc-title">The Senior Supplement Stack</div><span className="gc-price">$17</span></div></a>
        </div>

        {/* BUNDLE */}
        <div className="bundle">
          <div className="bundle-books">
            <div className="bw"><div className="bk"><div className="bk-f"><img src="/assets/covers/heart-bp-protocol.webp" alt="Heart After 60" style={{width:'100%',height:'100%',objectFit:'cover'}} loading="lazy" /></div><div className="bk-sp" style={{background:'#7f1d1d'}}></div><div className="bk-pg"></div><div className="bk-sh"></div></div></div>
            <div className="bw"><div className="bk"><div className="bk-f"><img src="/assets/covers/brain-memory-shield.webp" alt="Brain Shield" style={{width:'100%',height:'100%',objectFit:'cover'}} loading="lazy" /></div><div className="bk-sp" style={{background:'#4c1d95'}}></div><div className="bk-pg"></div><div className="bk-sh"></div></div></div>
            <div className="bw"><div className="bk"><div className="bk-f"><img src="/assets/covers/supplement-blueprint.webp" alt="Supplement Stack" style={{width:'100%',height:'100%',objectFit:'cover'}} loading="lazy" /></div><div className="bk-sp" style={{background:'#0f3320'}}></div><div className="bk-pg"></div><div className="bk-sh"></div></div></div>
          </div>
